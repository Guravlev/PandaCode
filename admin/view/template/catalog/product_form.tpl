        ...
        <div id="tab-data">
          <table class="form">
            ...
            <tr>
              ...
              <td><input type="text" name="my_discount" value="<?php echo $my_discount; ?>" /></td>
            </tr>
            <tr>
              <td><?php echo $entry_type_of_discount; ?></td>
              <td><select name="discount_type">
                      <?php if ($discount_type) { ?>
                      <option value="1" selected="selected"><?php echo $discount_currency; ?></option>
                      <option value="0">%</option>
                      <?php } else { ?>
                      <option value="1"><?php echo $discount_currency; ?></option>
            ...
            <tr>
              ...
              <td>
                  <div class="image">
                      <img src="<?php echo $discount_thumb; ?>" alt="" id="discount_thumb" /><br />
                      <input type="hidden" name="discount_image" value="<?php echo $discount_image; ?>" id="discount_image" />
                      <a onclick="image_upload('discount_image', 'discount_thumb');">
                          <?php echo $text_browse; ?>
                      </a>&nbsp;&nbsp;|&nbsp;&nbsp;
                      <a onclick="$('#discount_thumb').attr('src', '');
                        $('#discount_image').attr('value', '');"><?php echo $text_clear; ?>
                      </a>
                  </div></br>
                  <input type="text" name="discount_image_width" value="<?php echo $discount_image_width; ?>" size="3" />
                  x
                  <input type="text" name="discount_image_height" value="<?php echo $discount_image_height; ?>" size="3" />
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td><div class="image"><img src="<?php echo $thumb; ?>" alt="" id="thumb" /><br />
                  ...
                  <a onclick="$('#thumb').attr('src', '<?php echo $no_image; ?>');
                      $('#image').attr('value', 'no_image.jpg');"><?php echo $text_clear; ?>
                  </a>
                  </div>
              </td>
            </tr>
              ...
              <tr>
                ...
                <td class="left"><?php foreach ($languages as $language) { ?>
                  <textarea name="product_attribute[<?php echo $attribute_row; ?>][product_attribute_description][<?php echo $language['language_id']; ?>][text]" cols="40" rows="5">
                      <?php echo isset($product_attribute['product_attribute_description'][$language['language_id']]) ? $product_attribute['product_attribute_description'][$language['language_id']]['text'] : ''; ?></textarea>
