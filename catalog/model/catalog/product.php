	...
	public function getProduct($product_id) {
		...
		if ($query->num_rows) {
			return array(
				...
				'my_discount'	   => $query->row['my_discount'],
				'discount_type'	   => $query->row['discount_type'],
				'discount_image_width'	   => $query->row['discount_image_width'],
				'discount_image_height'	   => $query->row['discount_image_height'],
				'sku'              => $query->row['sku'],
				'upc'              => $query->row['upc'],
				'ean'              => $query->row['ean'],
				'jan'              => $query->row['jan'],
				...
				'discount_image'   => $query->row['discount_image'],
...
//		$product_data['sql']=$sql;
	...
	public function getDiscountImages($product_id) {
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "discount_image WHERE product_id = '" . (int)$product_id . "' ORDER BY sort_order ASC");
